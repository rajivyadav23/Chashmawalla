...
<?php } else { ?>
	...
	<p class="meta">
		...
		?>
		<span class="woocommerce-review__dash">&ndash;</span> <time class="woocommerce-review__published-date" datetime="<?php echo esc_attr( get_comment_date( 'c' ) ); ?>"><?php echo esc_html( molla_get_human_time( strtotime( get_comment_time() . ' ' . get_comment_date() ) ) . ' ago' ); ?></time>
	</p>
